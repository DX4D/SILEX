...
/*:
 * @plugindesc (v0.1b) Sistema avançado de interação de eventos.
 * @author Moghunter
 *
 * @param Tool Map ID
...
Game_CharacterBase.prototype.loadOrgParameters = function(direction) {
	...
	if (Imported.MOG_CharPoses) {this._originalName.name = this._chrono.orgoriginalName};
...
Game_CharacterBase.prototype.act = function(toolID) {
	...
	if (this.isRequiredCast(toolID)) {this.prepareCast(toolID);return};
	if (this.isAutoTarget(toolID)) {this.executeAutoTarget(toolID);return};
...
Game_Player.prototype.canCallMenu = function() {
	...
	if ($gameTemp._autoTarget.enabled) {return false};
	if ($gamePlayer.isCasting()) {return false};
	if ($gamePlayer.isKnockbacking()) {return false};
	if ($gamePlayer.isGuarding()) {return false};
	return true;
};
...
//	if ($gameSystem.isAbsMode() && target._user.isFollower) {return false};
	...
	if (target.battler()) {
	   ...
	   if (!this._tool.autoTarget && target.battler()._ras.collisionD > 0) {return false};
...
ToolEvent.prototype.canCollideBattler = function(target) {
	...
	if (this.isInvunerableAction(target.battler())) {
...
//==============================
ToolEvent.prototype.isInvunerableAction = function(battler) {
	if (battler._ras.invunerable) {return true};
...
// ** create Upper Layer
//==============================
var _mog_ras_sprtbase_createUpperLayer = Spriteset_Base.prototype.createUpperLayer;
Spriteset_Base.prototype.createUpperLayer = function() {
	_mog_ras_sprtbase_createUpperLayer.call(this);
...
// * create Hud Field
//==============================
Spriteset_Map.prototype.createHudField = function() {
	this._hudField = new Sprite();
    this.addChild(this._hudField);
};
...
Spriteset_Map.prototype.createToolSysSprites = function() {
	...
	this.createHookshot();
	if (Imported.MOG_ActionName) {this.createActionName()};
};
...
Spriteset_Map.prototype.createChronoField = function() {
	...
	this.addChild(this._chronoField);
};
...
Spriteset_Map.prototype.createChronoSprites = function() {
	...
	if (Imported.MOG_BossHP) {this.createBossHPGauge()};
...
Spriteset_Map.prototype.removeChronoSprites = function() {
	...
	if (Imported.MOG_BossHP) {this.removeBossHPGauge()};
	if (this._chronoWindow) {this._chronoField.removeChild(this._chronoWindow)};
...
Spriteset_Map.prototype.createChronoWindows = function() {
	...
	this._chronoField.addChild(this._chronoWindow);
};
