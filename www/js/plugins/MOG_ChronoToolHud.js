...
/*:
 * @plugindesc (v1.1) Apresenta as huds das ações no Chrono Engine.
 * @author Moghunter
 *
...
// * create All Windows
//==============================
var _mog_toolSys_scMap_createAllWindows = Scene_Map.prototype.createAllWindows;
Scene_Map.prototype.createAllWindows = function() {
	this.createToolHud();
	_mog_toolSys_scMap_createAllWindows.call(this);	
};

//==============================
// * create Tool Hud
//==============================
Scene_Map.prototype.createToolField = function() {
	this.toolField = new Sprite();
	this.addChild(this.toolField);
};
...
Scene_Map.prototype.createToolHud = function() {
	this.createToolField()
	this._toolHud = [];
	for (var i = 0; i < 4; i++) {
        this._toolHud[i] = new ToolHud(i);
		this.toolField.addChild(this._toolHud[i]);
	};
};
